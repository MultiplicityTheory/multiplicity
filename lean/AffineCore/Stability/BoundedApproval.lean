...
theorem suspension_persists_without_authorized_clear
  ...
  get_suspension_state (log ++ [r]) = some key :=
by
  unfold get_suspension_state
  simp [List.foldl_append]
  rw [←List.foldl_fixed_prefix get_suspension_state] -- Needs helper or induction
  sorry -- Structural proof of foldl monotonicity for this state machine
